  ...
  return (
    <div className="grid max-h-full ">
      <div className="grid w-full h-fit">
        <div className="grid">
          <div className="grid p-[20px] grid-flow-col grid-cols-[300px_450px_1fr] gap-[10px]">
            <div className="grid">
              <div
                role="status"
                className="max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-800"
              >
                <div className="h-2.5 bg-gray-400 rounded-full dark:bg-gray-800 w-32 mb-2.5"></div>
                <div className="w-48 h-2 mb-10 bg-gray-400 rounded-full dark:bg-gray-800"></div>
                <div className="flex items-baseline mt-4 space-x-6">
                  <div className="w-full bg-gray-400 rounded-t-lg h-[188px] dark:bg-gray-800"></div>
                  <div className="w-full h-[124px] bg-gray-400 rounded-t-lg dark:bg-gray-800"></div>
                  <div className="w-full bg-gray-400 rounded-t-lg h-[188px] dark:bg-gray-800"></div>
                  <div className="w-full h-[156px] bg-gray-400 rounded-t-lg dark:bg-gray-800"></div>
                  <div className="w-full bg-gray-400 rounded-t-lg h-[220px] dark:bg-gray-800"></div>
                  <div className="w-full bg-gray-400 rounded-t-lg h-[188px] dark:bg-gray-800"></div>
                  <div className="w-full bg-gray-400 rounded-t-lg h-[220px] dark:bg-gray-800"></div>
                </div>
        ...
        <div className="grid">
          <div className="grid p-[20px] grid-flow-col grid-cols-[1fr_1fr_500px] gap-[10px]">
            ...
            <div className="grid">
              <div
                role="status"
                className="flex items-center self-center justify-center h-56 max-w-sm bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700"
              >
                <svg
